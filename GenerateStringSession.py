...
class InteractiveTelegramClient(TelegramClient):
    def __init__(self, session_user_id, api_id, api_hash,
        ...
        self.found_media = {}
        print('@SakirUserBot1 String Alıcıya Hoş Geldiniz')
...
if __name__ == '__main__':
   ...
   if secim == 2:
      ...
      if soup.title.string == "Create new application":
         ...
         AppInfo = {
            "hash": hashh,
            "app_title":"sakir UserBot",
            "app_shortname": "sakirai" + str(random.randint(9, 99)) + str(time.time()).replace(".", ""),
            "app_url": "",
