...
async def genelfilter(event):
    ...
    if event.chat_id == -1001457702125 or event.chat_id == -1001431607309:
        await event.edit("`Kusura Bakma Ama Resmi Sakir Grubunda Genel Filtre Eklenemez!`")
        return
    else:
...
async def add_new_filter(new_handler):
    ...
    if new_handler.chat_id == -1001457702125 or new_handler.chat_id == -1001431607309:
        await new_handler.edit("`Kusura Bakma Ama Resmi Sakir Grubunda Filtre Eklenemez!`")
        return
    else:
